...
#dat4 <- simdataLNIRT2(N = 1000, K = 15, delta = 0.2, tau = 0.1, nu = seq(-0.2, 0.2, length.out = 15))
dat4 <- simdataLNIRT(N = 1000, K = 25, delta = c(0.2,0), tau = c(0.15,0), nu = seq(-0.25, 0.25, length.out = 25))
